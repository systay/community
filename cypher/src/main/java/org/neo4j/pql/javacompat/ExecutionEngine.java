...
{
    private org.neo4j.pql.ExecutionEngine inner;
    ...
    {
        inner = new org.neo4j.pql.ExecutionEngine( database );
    }
     ...
     * @throws org.neo4j.pql.SyntaxException If the Query contains errors,
